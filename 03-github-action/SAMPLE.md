...
AI에게 일을 부탁할 때 아래 틀을 사용하면 누락이 줄어듭니다.

```text
[목표]
무엇을 만들거나 고칠지 한 문장으로 써 줘.

[현재 문제]
지금 무엇이 불편하거나 잘못되는지 써 줘.
...
[안전 범위]
실제 고객 데이터와 비밀키는 사용하지 마.
이슈 범위 밖의 파일은 바꾸지 마.
변경 후 내가 확인할 항목을 알려 줘.
```

좋은 요청은 “알아서 해 줘”보다 **목표, 완료 조건, 금지 사항, 확인 방법**을 구체적으로 적습니다.
